        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row gap-12">
              ...
              >
                ...
                <div className={`h-64 w-full bg-gradient-to-br ${project.color} flex items-center justify-center relative overflow-hidden group-hover:scale-[1.02] transition-transform duration-500`}>
                  ...
                  <div className="relative z-10 text-center">
                    <span className="text-2xl font-bold font-heading text-primary/80">{project.title}</span>
                    <p className="text-sm text-primary/60 mt-2">Live Preview</p>
                  </div>
                  ...
                  <a 
                    ...
                    className="absolute inset-0 z-20 flex items-center justify-center bg-primary/80 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                  >
                    <span className="flex items-center text-white font-medium px-6 py-3 rounded-full bg-white/20 backdrop-blur-md">
                  ...
                  <div className="mt-auto">
                    <div className="flex flex-wrap gap-2 mb-6">
                      {project.services.map((service, sIndex) => (
                        <span key={sIndex} className="px-3 py-1 bg-gray-50 border border-gray-100 text-gray-600 text-xs rounded-full">
                          {service}
                        </span>
                      ))}
                    </div>
          ...
          <div className="lg:w-80 flex-shrink-0">
            <div className="sticky top-32 bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 text-sm mb-8">Ready to build something amazing? Reach out to us directly.</p>
              ...
              <div className="space-y-4">
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex items-center w-full p-4 rounded-xl bg-gray-50 hover:bg-[#25D366]/10 text-primary hover:text-[#25D366] transition-colors group"
                >
                ...
                <a 
                  ...
                  className="flex items-center w-full p-4 rounded-xl bg-gray-50 hover:bg-accent/10 text-primary hover:text-accent transition-colors group"
                >
                  <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center shadow-sm mr-4 group-hover:scale-110 transition-transform">
                ...
                <a 
                  ...
                  className="flex items-center w-full p-4 rounded-xl bg-gray-50 hover:bg-primary/5 text-primary transition-colors group"
                >
                  <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center shadow-sm mr-4 group-hover:scale-110 transition-transform">
