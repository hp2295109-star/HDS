      ...
      <main className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 lg:grid-rows-6 gap-5 lg:h-[800px]">
          ...
          <motion.div 
            ...
            className="lg:col-span-7 lg:row-span-4 bg-white rounded-[32px] p-8 md:p-12 border border-black/5 shadow-sm flex flex-col justify-center relative overflow-hidden"
          >
            <div className="absolute top-0 right-0 p-8 opacity-20 hidden md:block">
              <svg width="120" height="120" viewBox="0 0 24 24" fill="none" stroke="#2AD28E" strokeWidth="1">
                <circle cx="12" cy="12" r="10" strokeDasharray="4 4"/>
              </svg>
            </div>
            <div className="inline-flex w-max bg-accent/10 text-accent px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider mb-8">
              Premium Web Design & AI Automation
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-heading tracking-tight mb-6 leading-[1.1]">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <Link 
                to="/contact" 
                className="w-full sm:w-auto inline-flex items-center justify-center px-8 py-4 text-base font-medium text-white bg-primary rounded-xl hover:bg-secondary transition-all shadow-lg shadow-primary/20 hover:scale-[1.02] active:scale-[0.98]"
              >
                Book Free Website Audit
              </Link>
              <Link 
                to="/portfolio" 
                className="w-full sm:w-auto inline-flex items-center justify-center px-8 py-4 text-base font-medium text-primary bg-transparent border border-black/10 rounded-xl hover:bg-gray-50 transition-all hover:scale-[1.02] active:scale-[0.98]"
              >
                View Portfolio
              </Link>
            </div>
          ...
          <motion.div 
            ...
            className="lg:col-span-5 lg:row-span-2 bg-primary rounded-[32px] p-8 text-white flex flex-col justify-between relative overflow-hidden shadow-sm"
          >
          ...
          <motion.div 
            ...
            className="lg:col-span-5 lg:row-span-2 bg-white border border-black/5 rounded-[32px] p-8 shadow-sm flex flex-col justify-between"
          >
            <div className="text-xs font-bold uppercase text-gray-400 tracking-widest mb-6">Recent Success</div>
            
            <div className="space-y-4">
              <div className="flex items-center space-x-4 p-4 bg-gray-50 rounded-2xl border border-black/5 group hover:border-accent/30 transition-colors">
                ...
                <div>
                  <div className="text-sm font-bold text-primary">Unique Salon</div>
                  <div className="text-[11px] text-gray-500 uppercase tracking-wider mt-0.5">Beauty & Wellness</div>
                </div>
              ...
              <div className="flex items-center space-x-4 p-4 bg-gray-50 rounded-2xl border border-black/5 group hover:border-accent/30 transition-colors">
                ...
                <div>
                  <div className="text-sm font-bold text-primary">The Muscle Gym</div>
                  <div className="text-[11px] text-gray-500 uppercase tracking-wider mt-0.5">Fitness Center</div>
                </div>
                <div className="flex-1"></div>
          ...
          <motion.div 
            ...
            className="lg:col-span-4 lg:row-span-2 bg-white border border-black/5 rounded-[32px] p-8 flex flex-col justify-center items-center text-center shadow-sm relative group"
          >
            ...
            <div className="text-xl font-bold font-heading mb-2 text-primary">AI Automation</div>
            <div className="text-sm text-gray-500 max-w-[200px]">Streamline leads & booking with custom AI workflows.</div>
          </motion.div>
          ...
          >
            ...
            <a href="mailto:harshpatelyt1060@gmail.com" className="bg-white text-primary py-3 mt-8 lg:mt-0 text-center rounded-xl font-bold text-sm z-10 hover:bg-gray-50 transition-colors">
              Send Email
            </a>
          </motion.div>
      ...
      <section className="py-24 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">Future-proof your local business with a modern digital presence.</p>
          </div>
